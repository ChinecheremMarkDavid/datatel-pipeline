CREATE TABLE IF NOT EXISTS `{{ var.value.gcp_project }}.{{ var.value.bq_dataset }}.dw_user_analytics` (
  customer_id STRING,
...
MERGE `{{ var.value.gcp_project }}.{{ var.value.bq_dataset }}.dw_user_analytics` T
USING `{{ var.value.gcp_project }}.{{ var.value.bq_dataset }}.dw_user_analytics_staging` S
